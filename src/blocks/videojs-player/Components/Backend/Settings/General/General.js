    ...
    <>
      ...
      <PanelBody
        ...
        <ToggleControl
          ...
          help={__(
            "Enable this for external video links to allow captions/subtitles to load. Disable it for local or self-hosted videos.",
            "video-player-block"
          )}
        />
        ...
        <div className="mt15">
          <SelectControl
            ...
            help={__(
              "Controls how much of the video is loaded when the page loads. 'Auto' loads the entire video, which can impact page load time. 'None' only loads the first frame.",
              "video-player-block",
            )}
          />
        </div>
