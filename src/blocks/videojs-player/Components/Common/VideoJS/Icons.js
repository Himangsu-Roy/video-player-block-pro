...
export const SeekIcon = ({ flipped }) => (
  <svg className={`media-icon media-icon--seek${flipped ? " media-icon--flipped" : ""}`} xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" aria-hidden="true" viewBox="0 0 18 18">
