    ...
    <>
        ...
        <div className="mt15">
          ...
          <div
            ...
            <button
              ...
              {__("Add Text Track", "video-player-block")}
            </button>
          </div>
        </div>
      </PanelBody>
          ...
          <SelectControl
            ...
            help={
              effectiveDimensions.height
                ? __("Disabled when height is set explicitly.", "video-player-block")
                : undefined
            }
          />
        </div>
      ...
      <PanelBody
        ...
        <ToggleControl
          ...
          help={__(
            "Required for loading external subtitle/VTT files. Keep enabled if using captions from a different domain.",
            "video-player-block",
          )}
        />
        ...
        <div className="mt15">
          <TextControl
            ...
            help={__(
              "Comma-separated list of rates (e.g. 0.5, 1, 1.5, 2)",
              "video-player-block",
            )}
          />
        </div>
      ...
      <PanelBody
        ...
        <ToggleControl
          label={__("Show Seek Controls", "video-player-block")}
          checked={effectiveControls.showSeekControls}
          onChange={(val) => updateControls("showSeekControls", val)}
        />
        ...
        <ToggleControl
          label={__("Show Playback Rate", "video-player-block")}
          checked={effectiveControls.showPlaybackRateControl}
          onChange={(val) => updateControls("showPlaybackRateControl", val)}
        />
        ...
        <ToggleControl
          label={__("Show Airplay Control", "video-player-block")}
          checked={effectiveControls.showAirplayControl !== false}
          onChange={(val) => updateControls("showAirplayControl", val)}
        />
      </PanelBody>
    </>
  );
