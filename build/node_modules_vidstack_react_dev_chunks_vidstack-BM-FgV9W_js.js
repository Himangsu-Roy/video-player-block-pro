"use strict";
(globalThis["webpackChunkvideo_player_block"] = globalThis["webpackChunkvideo_player_block"] || []).push([["node_modules_vidstack_react_dev_chunks_vidstack-BM-FgV9W_js"],{
...
function listenCastContextEvent(type, handler) {
  return (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_1__.listenEvent)(getCastContext(), type, handler);
}
...
class GoogleCastLoader {
  ...
  canPlay(src) {
    return _vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_0__.IS_CHROME && !_vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_0__.IS_IOS && (0,_vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_0__.canGoogleCastSrc)(src);
  }
  async prompt(ctx) {
    ...
    try {
      ...
      await this.#showPrompt((0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_1__.peek)(ctx.$props.googleCast));
  ...
  async load(ctx) {
    if (_vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_0__.IS_SERVER) {
  ...
  async #loadCastFramework(ctx) {
    ...
    await (0,_vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_0__.loadScript)(getCastFrameworkURL());
...
//# sourceMappingURL=node_modules_vidstack_react_dev_chunks_vidstack-BM-FgV9W_js.js.map?ver=f0d4da86a508801b4a9d