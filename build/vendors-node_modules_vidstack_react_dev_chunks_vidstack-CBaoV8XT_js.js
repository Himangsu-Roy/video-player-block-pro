"use strict";
(globalThis["webpackChunkvideo_player_block"] = globalThis["webpackChunkvideo_player_block"] || []).push([["vendors-node_modules_vidstack_react_dev_chunks_vidstack-CBaoV8XT_js"],{
...
/* harmony import */ var _vidstack_BM_FgV9W_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vidstack-BM-FgV9W.js */ "./node_modules/@vidstack/react/dev/chunks/vidstack-BM-FgV9W.js");
...
class GoogleCastTracksManager {
  ...
  setup() {
    ...
    (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.listenEvent)(this.#ctx.audioTracks, "change", syncRemoteActiveIds);
    (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.listenEvent)(this.#ctx.textTracks, "mode-change", syncRemoteActiveIds);
    (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.effect)(this.#syncLocalTracks.bind(this));
  }
  getLocalTextTracks() {
  ...
  #syncLocalTracks() {
    ...
    for (const localTrack of localTextTracks) {
      ...
      if (!hasRemoteTrack) {
        (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.untrack)(() => this.#onNewLocalTracks?.());
        break;
      }
    }
  }
  syncRemoteTracks(event) {
    ...
    for (const remoteAudioTrack of remoteAudioTracks) {
      ...
      this.#ctx.audioTracks[_vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_1__.ListSymbol.add](localAudioTrack, event);
    }
  ...
  #editTracksInfo(request) {
    const media = (0,_vidstack_BM_FgV9W_js__WEBPACK_IMPORTED_MODULE_2__.getCastSessionMedia)();
...
class GoogleCastProvider {
   ...
   */
  get cast() {
    return (0,_vidstack_BM_FgV9W_js__WEBPACK_IMPORTED_MODULE_2__.getCastContext)();
  }
  /**
   * @see {@link https://developers.google.com/cast/docs/reference/web_sender/cast.framework.CastSession}
   */
  get session() {
    return (0,_vidstack_BM_FgV9W_js__WEBPACK_IMPORTED_MODULE_2__.getCastSession)();
  }
  /**
   * @see {@link https://developers.google.com/cast/docs/reference/web_sender/chrome.cast.media.Media}
   */
  get media() {
    return (0,_vidstack_BM_FgV9W_js__WEBPACK_IMPORTED_MODULE_2__.getCastSessionMedia)();
  }
  /**
   * Whether the current Google Cast session belongs to this provider.
   */
  get hasActiveSession() {
    return (0,_vidstack_BM_FgV9W_js__WEBPACK_IMPORTED_MODULE_2__.hasActiveCastSession)(this.#currentSrc);
  }
  setup() {
  ...
  #attachCastContextEventListeners() {
    (0,_vidstack_BM_FgV9W_js__WEBPACK_IMPORTED_MODULE_2__.listenCastContextEvent)(
  ...
  #attachCastPlayerEventListeners() {
    ...
    for (const type of (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.keysOf)(handlers)) {
      this.#player.controller.addEventListener(type, handler);
    }
    (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.onDispose)(() => {
      for (const type of (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.keysOf)(handlers)) {
  ...
  async loadSource(src) {
    ...
    if ((0,_vidstack_BM_FgV9W_js__WEBPACK_IMPORTED_MODULE_2__.hasActiveCastSession)(src)) {
      this.#resumeSession();
      this.#currentSrc = src;
      return;
    }
    ...
    if (errorCode) {
      ...
      this.#ctx.notify("error", Error((0,_vidstack_BM_FgV9W_js__WEBPACK_IMPORTED_MODULE_2__.getCastErrorMessage)(errorCode)));
      return;
    }
    this.#currentSrc = src;
  }
  ...
  #resumeSession() {
    const resumeSessionEvent = new _vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.DOMEvent("resume-session", { detail: this.session });
  ...
  #onMediaLoadedChange(event) {
    ...
    Promise.resolve().then(() => {
      if (src !== (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.peek)(this.#ctx.$state.source) || !this.#player.isMediaLoaded) return;
      this.#reset();
  ...
  #onProgress(event) {
    const detail = {
      seekable: this.#getSeekableRange(),
      buffered: new _vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_1__.TimeRange(0, this.#played)
  ...
  #getSeekableRange() {
    return this.#player.liveSeekableRange ? new _vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_1__.TimeRange(this.#player.liveSeekableRange.start, this.#player.liveSeekableRange.end) : this.#seekableRange;
  }
  #createEvent(detail) {
    return detail instanceof Event ? detail : new _vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.DOMEvent(detail.type, { detail });
  }
  #buildMediaInfo(src) {
...
//# sourceMappingURL=vendors-node_modules_vidstack_react_dev_chunks_vidstack-CBaoV8XT_js.js.map?ver=a15f0fb8752091cf04a5