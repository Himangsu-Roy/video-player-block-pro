"use strict";
(globalThis["webpackChunkvideo_player_block"] = globalThis["webpackChunkvideo_player_block"] || []).push([["vendors-node_modules_vidstack_react_dev_chunks_vidstack-CoE5RD0i_js"],{
...
/* harmony import */ var _vidstack_Dm1xEU9Q_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./vidstack-Dm1xEU9Q.js */ "./node_modules/@vidstack/react/dev/chunks/vidstack-Dm1xEU9Q.js");
...
class YouTubeProvider extends _vidstack_D8t5kEKd_js__WEBPACK_IMPORTED_MODULE_2__.EmbedProvider {
  ...
  async loadSource(src) {
    ...
    const videoId = (0,_vidstack_Dm1xEU9Q_js__WEBPACK_IMPORTED_MODULE_3__.resolveYouTubeVideoId)(src.src);
  ...
  onMessage({ info }, event) {
    ...
    if ((0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.isObject)(info.videoData) && info.videoData.title !== title()) {
      this.#ctx.notify("title-change", info.videoData.title, event);
    }
    if ((0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.isNumber)(info.duration) && info.duration !== intrinsicDuration()) {
      if ((0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.isNumber)(info.videoLoadedFraction)) {
        const buffered = info.progressState?.loaded ?? info.videoLoadedFraction * info.duration, seekable = new _vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_1__.TimeRange(0, info.duration);
        this.#onProgress(buffered, seekable, event);
      }
      this.#ctx.notify("duration-change", info.duration, event);
    }
    if ((0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.isNumber)(info.playbackRate) && info.playbackRate !== playbackRate()) {
    ...
    if (info.progressState) {
      ...
      this.#onProgress(loaded, new _vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_1__.TimeRange(seekableStart, seekableEnd), event);
      if (duration !== intrinsicDuration()) {
        this.#ctx.notify("duration-change", duration, event);
      }
    }
    if ((0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.isNumber)(info.volume) && (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.isBoolean)(info.muted) && !this.#invalidPlay) {
      const detail = {
        muted: info.muted,
    ...
    if ((0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.isNumber)(info.playerState) && info.playerState !== this.#state) {
...
//# sourceMappingURL=vendors-node_modules_vidstack_react_dev_chunks_vidstack-CoE5RD0i_js.js.map?ver=8a74e28594aa53deb465