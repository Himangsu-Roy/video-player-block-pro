"use strict";
(globalThis["webpackChunkvideo_player_block"] = globalThis["webpackChunkvideo_player_block"] || []).push([["vendors-node_modules_vidstack_react_dev_chunks_vidstack-Bt-dOpts_js"],{
...
/* harmony import */ var _vidstack_D8t5kEKd_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vidstack-D8t5kEKd.js */ "./node_modules/@vidstack/react/dev/chunks/vidstack-D8t5kEKd.js");
/* harmony import */ var _vidstack_krOAtKMi_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./vidstack-krOAtKMi.js */ "./node_modules/@vidstack/react/dev/chunks/vidstack-krOAtKMi.js");
...
class VimeoProvider extends _vidstack_D8t5kEKd_js__WEBPACK_IMPORTED_MODULE_2__.EmbedProvider {
  $$PROVIDER_TYPE = "VIMEO";
  scope = (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.createScope)();
  fullscreen;
  #ctx;
  #videoId = (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.signal)("");
  #pro = (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.signal)(false);
  #hash = null;
  #currentSrc = null;
  #fullscreenActive = false;
  #seekableRange = new _vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_1__.TimeRange(0, 0);
  #timeRAF = new _vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_1__.RAFLoop(this.#onAnimationFrame.bind(this));
  #currentCue = null;
  #chaptersTrack = null;
  ...
  preconnect() {
    (0,_vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_1__.preconnect)(this.getOrigin());
  }
  setup() {
    super.setup();
    (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.effect)(this.#watchVideoId.bind(this));
    (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.effect)(this.#watchVideoInfo.bind(this));
    (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.effect)(this.#watchPro.bind(this));
  ...
  setVolume(volume) {
    ...
    this.#remote("setMuted", (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.peek)(this.#ctx.$state.muted));
  }
  setPlaybackRate(rate) {
    this.#remote("setPlaybackRate", rate);
  }
  async loadSource(src) {
    if (!(0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.isString)(src.src)) {
      this.#currentSrc = null;
      this.#hash = null;
      this.#videoId.set("");
      return;
    }
    const { videoId, hash } = (0,_vidstack_krOAtKMi_js__WEBPACK_IMPORTED_MODULE_3__.resolveVimeoVideoId)(src.src);
  ...
  #watchVideoInfo() {
    const videoId = this.#videoId();
    if (!videoId) return;
    const promise = (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.deferredPromise)(), abort = new AbortController();
    this.#videoInfoPromise = promise;
    (0,_vidstack_krOAtKMi_js__WEBPACK_IMPORTED_MODULE_3__.getVimeoVideoInfo)(videoId, abort, this.#hash).then((info) => {
  ...
  #watchPro() {
    ...
    qualities[_vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_1__.ListSymbol.setReadonly](!isPro);
    if (isPro) {
      return (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.listenEvent)(qualities, "change", () => {
  ...
  #onReady(duration, trigger) {
    ...
    this.#seekableRange = new _vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_1__.TimeRange(0, duration);
    const detail = {
      buffered: new _vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_1__.TimeRange(0, 0),
  ...
  #onMethod(method, data, trigger) {
    switch (method) {
      ...
      case "getCurrentTime":
        ...
        break;
      case "getBuffered":
        if ((0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.isArray)(data) && data.length) {
          this.#onLoadProgress(data[data.length - 1][1], trigger);
        }
        break;
      case "setMuted":
        this.#onVolumeChange((0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.peek)(this.#ctx.$state.volume), data, trigger);
        break;
      // case 'getTextTracks':
  ...
  #onLoadProgress(buffered, trigger) {
    const detail = {
      buffered: new _vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_1__.TimeRange(0, buffered),
      seekable: this.#seekableRange
    };
  ...
  #onChaptersChange(chapters) {
    ...
    const track = new _vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_1__.TextTrack({
      kind: "chapters",
      default: true
  ...
  #onQualitiesChange(qualities, trigger) {
    this.#ctx.qualities[_vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_1__.QualitySymbol.enableAuto] = qualities.some((q) => q.id === "auto") ? () => this.#remote("setQuality", "auto") : void 0;
    for (const quality of qualities) {
      if (quality.id === "auto") continue;
      const height = +quality.id.slice(0, -1);
      if (isNaN(height)) continue;
      this.#ctx.qualities[_vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_1__.ListSymbol.add](
        {
          id: quality.id,
          width: height * (16 / 9),
          height,
  ...
  #onQualityChange({ id } = {}, trigger) {
    ...
    if (isAuto) {
      this.#ctx.qualities[_vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_1__.QualitySymbol.setAuto](isAuto, trigger);
      this.#ctx.qualities[_vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_1__.ListSymbol.select](void 0, true, trigger);
    } else {
      this.#ctx.qualities[_vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_1__.ListSymbol.select](newQuality ?? void 0, true, trigger);
    }
  }
  #onEvent(event, payload, trigger) {
    switch (event) {
      ...
      case "bufferend":
        ...
        break;
      case "volumechange":
        this.#onVolumeChange(payload.volume, (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.peek)(this.#ctx.$state.muted), trigger);
        break;
      case "durationchange":
        this.#seekableRange = new _vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_1__.TimeRange(0, payload.duration);
  ...
  async #remote(command, arg) {
    let promise = (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_0__.deferredPromise)(), promises = this.#promises.get(command);
  ...
  #reset() {
    this.#timeRAF.stop();
    this.#seekableRange = new _vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_1__.TimeRange(0, 0);
...
/* harmony export */ });
/* harmony import */ var _vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./vidstack-DUlCophs.js */ "./node_modules/@vidstack/react/dev/chunks/vidstack-DUlCophs.js");
...
class EmbedProvider {
  #iframe;
  src = (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_1__.signal)("");
  /**
  ...
  setup() {
    (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_1__.listenEvent)(window, "message", this.#onWindowMessage.bind(this));
    (0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_1__.listenEvent)(this.#iframe, "load", this.onLoad.bind(this));
  ...
  #watchSrc() {
    ...
    this.#iframe.setAttribute("src", (0,_vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_0__.appendParamsToURL)(src, params));
  }
  postMessage(message, target) {
    if (_vidstack_DUlCophs_js__WEBPACK_IMPORTED_MODULE_0__.IS_SERVER) return;
    this.#iframe.contentWindow?.postMessage(JSON.stringify(message), target ?? "*");
  }
  #onWindowMessage(event) {
    const origin = this.getOrigin(), isOriginMatch = (event.source === null || event.source === this.#iframe?.contentWindow) && (!(0,_vidstack_D_bWd66h_js__WEBPACK_IMPORTED_MODULE_1__.isString)(origin) || origin === event.origin);
...
//# sourceMappingURL=vendors-node_modules_vidstack_react_dev_chunks_vidstack-Bt-dOpts_js.js.map?ver=aa0433eb59d61ebd7f93